...
describe("anakins-cscope.goto_incoming_calls", function()
    ...
    _it("uses visual selection for rest_init", function()
        vim.cmd.edit(cs.cwd .. "init/main.c")
        vim.api.nvim_buf_set_mark(0, '<', 714, 38, {})
        vim.api.nvim_buf_set_mark(0, '>', 714, 46, {})
        cs.goto_incoming_calls()
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(1210, row, "wrong row")
    ...
    _it("argument takes precedence over visual selection", function()
        vim.cmd.edit(cs.cwd .. "init/main.c")
        vim.api.nvim_buf_set_mark(0, '<', 714, 20, {})
        vim.api.nvim_buf_set_mark(0, '>', 714, 30, {})
        cs.goto_incoming_calls('rest_init')
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(1210, row, "wrong row")
...
describe("anakins-cscope.goto_outgoing_calls", function()
    ...
    _it("uses visual selection for do_trace_initcall_level", function()
        vim.cmd.edit(cs.cwd .. "init/main.c")
        vim.api.nvim_buf_set_mark(0, '<', 1364, 19, {})
        vim.api.nvim_buf_set_mark(0, '>', 1364, 41, {})
        cs.goto_outgoing_calls()
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(1368, row, "wrong row")
    ...
    _it("argument takes precedence over visual selection", function()
        vim.cmd.edit(cs.cwd .. "init/main.c")
        vim.api.nvim_buf_set_mark(0, '<', 1364, 20, {})
        vim.api.nvim_buf_set_mark(0, '>', 1364, 30, {})
        cs.goto_outgoing_calls('do_trace_initcall_level')
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(1368, row, "wrong row")
...
describe("anakins-cscope.references", function()
    ...
    _it("uses visual selection for add_latent_entropy", function()
        vim.cmd.edit(cs.cwd .. "init/main.c")
        vim.api.nvim_buf_set_mark(0, '<', 1397, 1, {})
        vim.api.nvim_buf_set_mark(0, '>', 1397, 18, {})
        cs.references()
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(1397, row, "wrong row")
    ...
    _it("argument takes precedence over visual selection", function()
        vim.cmd.edit(cs.cwd .. "init/main.c")
        vim.api.nvim_buf_set_mark(0, '<', 1397, 20, {})
        vim.api.nvim_buf_set_mark(0, '>', 1397, 30, {})
        cs.references('add_latent_entropy')
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(1397, row, "wrong row")
...
describe("anakins-cscope.goto_definition", function()
    ...
    _it("uses visual selection for regmap_reg_range", function()
        vim.cmd.edit(cs.cwd .. "drivers/pmdomain/imx/gpc.c")
        vim.api.nvim_buf_set_mark(0, '<', 328, 1, {})
        vim.api.nvim_buf_set_mark(0, '>', 328, 16, {})
        cs.goto_definition()
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(234, row, "wrong row")
    ...
    _it("argument takes precedence over visual selection", function()
        vim.cmd.edit(cs.cwd .. "drivers/pmdomain/imx/gpc.c")
        vim.api.nvim_buf_set_mark(0, '<', 328, 20, {})
        vim.api.nvim_buf_set_mark(0, '>', 328, 30, {})
        cs.goto_definition('regmap_reg_range')
        vim.wait(delay)
        local row, col = unpack(vim.api.nvim_win_get_cursor(0))
        assert.equal(234, row, "wrong row")
