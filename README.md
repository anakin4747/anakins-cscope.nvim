...
[+] Building 0.7s (10/10) FINISHED                                                                                                                             docker:default
 ...
 => [1/5] FROM docker.io/library/archlinux:base-20260111.0.480139@sha256:417aa2d3e8e4cc8377360a94bf48ae1ed38e593cbecfcb34feb16d57e3efa1b5                                0.0s
 ...
 => CACHED [2/5] RUN pacman -Syu --noconfirm     cloc     cocogitto     cscope     curl     git     jq     make     neovim     sudo     which                            0.0s
 => CACHED [3/5] COPY plenary-patches /plenary-patches                                                                                                                   0.0s
 => CACHED [4/5] RUN mkdir -p /usr/local/share/nvim/site/pack/plenary/start &&     cd /usr/local/share/nvim/site/pack/plenary/start &&     git clone --depth 1 https://  0.0s
 => CACHED [5/5] RUN mkdir -p /usr/local/share/nvim/site/pack/telescope/start &&     cd /usr/local/share/nvim/site/pack/telescope/start &&     git clone --depth 1 http  0.0s
 => exporting to image                                                                                                                                                   0.1s
 => => exporting layers                                                                                                                                                  0.0s
 => => exporting manifest sha256:6edd1111cdc2bf975fb1053574d09913e3c66824285c4f90105dfe21617dd1b8                                                                        0.0s
 => => exporting config sha256:adcf6083df4fe84c827998d03cf5e2086cd28d852692e8dc42bd0df1b53c14a6                                                                          0.0s
 => => exporting attestation manifest sha256:1f743bc4648767a4e566319f41bc7766068d199c5743bdbdcd194d28f26981e2                                                            0.0s
 => => exporting manifest list sha256:c222f50183388551f80dbf1f4fdfdce47705c243af96be2d7224e55694a24331                                                                   0.0s
 => => naming to docker.io/library/cqfd_kin_anakin4747_anakins-cscope_f302ad5:latest                                                                                     0.0s
 => => unpacking to docker.io/library/cqfd_kin_anakin4747_anakins-cscope_f302ad5:latest                                                                                  0.0s
...
SUCCESS anakins-cscope.goto_incoming_calls uses visual selection for rest_init
SUCCESS anakins-cscope.goto_incoming_calls argument takes precedence over visual selection
...
SUCCESS anakins-cscope.goto_outgoing_calls uses visual selection for do_trace_initcall_level
SUCCESS anakins-cscope.goto_outgoing_calls argument takes precedence over visual selection
...
SUCCESS anakins-cscope.references uses visual selection for add_latent_entropy
SUCCESS anakins-cscope.references argument takes precedence over visual selection
...
SUCCESS anakins-cscope.goto_definition uses visual selection for regmap_reg_range
SUCCESS anakins-cscope.goto_definition argument takes precedence over visual selection
...
SUCCESS anakins-cscope.toggle_logging sets should_log to true when toggled from disabled
SUCCESS anakins-cscope.toggle_logging sets should_log to false when toggled from enabled
SUCCESS anakins-cscope.toggle_logging CscopeLogToggle does not error when called as a command
SUCCESS anakins-cscope.toggle_logging toggles should_log through the command
